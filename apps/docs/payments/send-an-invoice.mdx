...
Whether your business sends customers an invoice upfront for providing a specific service, or the customer requires an invoice before making payment, you can create an invoice on Whop in a few seconds.

## How to create and send an invoice

![Invoicesgif Gi](/apps/docs/images/Invoicesgif.gif)
