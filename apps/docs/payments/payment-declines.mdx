...
## What happens when a subscription payment is declined
...
- To update their payment method, ask them to follow these steps:
  1. Go to https://whop.com/@me/settings/orders/
  2. Click the **arrow** button on the affected subscription
...
2. Click **Status** and select only **Past due**
3. Select the past due payment
